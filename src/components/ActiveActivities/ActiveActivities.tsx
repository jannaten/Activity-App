...
const formatCountdown = (timeSet: number): string => {
  if (timeSet > 60) {
...
const isUrgent = (timeSet: number): boolean => timeSet > 0 && timeSet <= 60;

export default function ActiveActivities(): React.ReactElement {
  const dispatch = useAppDispatch();
  const activitiesActive = useAppSelector(selectActiveActivities);
